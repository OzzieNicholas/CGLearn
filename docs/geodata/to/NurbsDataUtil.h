...
void transfer_1d_surface_into_geodata(std::shared_ptr<GeoData> geodata, NurbsAlgebraSurfacePtr surface);
...
std::vector<std::shared_ptr<INurbsBase>> extrude_surface_by_normal_keep_distance(NurbsComplexSurfacePtr surface, const nous::scalar value);
...
std::vector<std::shared_ptr<INurbsBase>> offset_surface_to_solid_with_transform(NurbsComplexSurfacePtr surface, const nous::transform3 transform);
...
std::vector<std::shared_ptr<INurbsBase>> offset_surface_to_solid_by_path(NurbsComplexSurfacePtr complex_surface,
