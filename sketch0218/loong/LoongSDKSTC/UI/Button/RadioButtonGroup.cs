...
{
    [ToolboxItem(true)]
    public partial class RadioButtonGroup : UserControl, IParamCtrl, ITabOrderCtrl
    {
        ...
        public Color HoveredButtonColor {
        ...
        [Browsable(false)]
        public object[] ButtonKeys {
            get => m_btnKeys;
            set => m_btnKeys = value;
        }

        [Browsable(false)]
        public object[] ButtonKeys1 {
            get => m_btnKeys1;
        ...
        private void Btn_MouseDown(object sender, MouseEventArgs e) {
            ...
            if (m_checkOnChange && !String.IsNullOrEmpty(m_ctrlCheckName) && this.Parent != null) {
                //检查是否需要重置关联的Check控件
                Control[] ctrls = this.Parent.Controls.Find(m_ctrlCheckName, true);
