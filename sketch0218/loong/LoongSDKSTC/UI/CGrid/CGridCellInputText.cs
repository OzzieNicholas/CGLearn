...
namespace LoongCAD.UI
{
    class CGridCellInputText : CGridCell
    {
        ...
        public override bool readOnly {
            ...
            set {
                m_readOnly = value;
                (m_ctrl as TextInput).ReadOnly = value;
                (m_ctrl as TextInput).CaretVisible = !value;
            }
        }
