...
#define BOXINTERSECT(b1, b2)                                                                                                                         \
    !(BOXLEFT(b1) + EPSILON >= BOXRIGHT(b2) || BOXBOTTOM(b1) + EPSILON >= BOXTOP(b2) || BOXRIGHT(b1) - EPSILON <= BOXLEFT(b2) ||                     \
...
{
    const boxPack *b1 = (const boxPack*)p1, *b2 = (const boxPack*)p2;
...
void boxPack2D(boxPack* boxarray, const int len, float* tot_width, float* tot_height)
{
    ...
    vert = vertarray = (boxVert*)MEM_mallocN(len * 4 * sizeof(boxVert), "boxPack Verts");
    vertex_pack_indices = (int*)MEM_mallocN(len * 3 * sizeof(int), "boxPack Indices");

    for(box = boxarray, box_index = 0, i = 0; box_index < len; box_index++, box++)
    {

        vert->blb = vert->brb = vert->tlb = vert->isect_cache[0] = vert->isect_cache[1] = vert->isect_cache[2] = vert->isect_cache[3] = NULL;
        ...
        vert->trb = vert->brb = vert->tlb = vert->isect_cache[0] = vert->isect_cache[1] = vert->isect_cache[2] = vert->isect_cache[3] = NULL;
        ...
        vert->trb = vert->blb = vert->tlb = vert->isect_cache[0] = vert->isect_cache[1] = vert->isect_cache[2] = vert->isect_cache[3] = NULL;
        ...
        vert->trb = vert->blb = vert->brb = vert->isect_cache[0] = vert->isect_cache[1] = vert->isect_cache[2] = vert->isect_cache[3] = NULL;
