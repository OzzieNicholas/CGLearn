...
#include "sketch/UV/SuperLU/colamd.h"
...
PRIVATE void init_scoring(int n_row, int n_col, RowInfo Row[], ColInfo Col[], int A[], int head[], double knobs[COLAMD_KNOBS], int* p_n_row2,
                          int* p_n_col2, int* p_max_deg);
...
#ifndef NDEBUG
    int n_col, RowInfo Row[],
#endif
    ColInfo Col[], int A[], int head[], int row_start, int row_length);
...
PRIVATE void debug_deg_lists(int n_row, int n_col, RowInfo Row[], ColInfo Col[], int head[], int min_score, int should, int max_deg);

PRIVATE void debug_mark(int n_row, RowInfo Row[], int tag_mark, int max_mark);

PRIVATE void debug_matrix(int n_row, int n_col, RowInfo Row[], ColInfo Col[], int A[]);

PRIVATE void debug_structures(int n_row, int n_col, RowInfo Row[], ColInfo Col[], int A[], int n_col2);
...
PRIVATE void debug_deg_lists(
    ...
    int n_row, int n_col, RowInfo Row[], ColInfo Col[], int head[], int min_score, int should, int max_deg)
{
    /* === Local variables ================================================== */
...
PRIVATE void debug_mark(
    ...
    int n_row, RowInfo Row[], int tag_mark, int max_mark)
{
    /* === Local variables ================================================== */
