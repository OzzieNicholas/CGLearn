...
static void initialize_disjoint_sets(int n) { pp = mxCallocInt(n); }
...
static void finalize_disjoint_sets(void) { SUPERLU_FREE(pp); }
 ...
 */
int sp_coletree(int* acolst, int* acolend, /* column start and end past 1 */
 ...
 */
int sp_symetree(int* acolst, int* acolend, /* column starts and ends past 1 */
                int* arow,                 /* row indices of A */
