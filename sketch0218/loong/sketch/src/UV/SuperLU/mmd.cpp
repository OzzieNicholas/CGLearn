...
#include "sketch/UV/SuperLU/stdafx.h"

typedef int shortint;

/* prototypes -------------------- */
int genmmd_(int*, int*, int*, int*, int*, int*, int*, int*, int*, int*, int*, int*);
int mmdint_(int*, int*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*);
int mmdelm_(int*, int*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, int*, int*);
int mmdupd_(int*, int*, int*, shortint*, int*, int*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, int*, int*);
...
/* Subroutine */ int genmmd_(int* neqns, int* xadj, shortint* adjncy, shortint* invp, shortint* perm, int* delta, shortint* dhead, shortint* qsize,
                             shortint* llist, shortint* marker, int* maxint, int* nofsub)
{
    ...
    extern /* Subroutine */ int mmdelm_(int*, int*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, int*, int*),
        mmdupd_(int*, int*, int*, shortint*, int*, int*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, int*, int*),
        mmdint_(int*, int*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*),
...
/* Subroutine */ int mmdint_(int* neqns, int* xadj, shortint* adjncy, shortint* dhead, shortint* dforw, shortint* dbakw, shortint* qsize,
...
/* Subroutine */ int mmdelm_(int* mdnode, int* xadj, shortint* adjncy, shortint* dhead, shortint* dforw, shortint* dbakw, shortint* qsize,
                             shortint* llist, shortint* marker, int* maxint, int* tag)
{
    ...
    /* Local variables */
    static int node, link, rloc, rlmt, i, j, nabor, rnode, elmnt, xqnbr, istop, jstop, istrt, jstrt, nxnode, pvnode, nqnbrs, npv;
...
/* Subroutine */ int mmdupd_(int* ehead, int* neqns, int* xadj, shortint* adjncy, int* delta, int* mdeg, shortint* dhead, shortint* dforw,
                             shortint* dbakw, shortint* qsize, shortint* llist, shortint* marker, int* maxint, int* tag)
{
    /* System generated locals */
    int i__1, i__2;

    /* Local variables */
    static int node, mtag, link, mdeg0, i, j, enode, fnode, nabor, elmnt, istop, jstop, q2head, istrt, jstrt, qxhead, iq2, deg, deg0;
...
/* Subroutine */ int mmdnum_(int* neqns, shortint* perm, shortint* invp, shortint* qsize)
{
    /* System generated locals */
    int i__1;
