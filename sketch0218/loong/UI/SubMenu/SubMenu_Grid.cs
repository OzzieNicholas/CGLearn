...
{
    [ToolboxItem(false)]
    public partial class SubMenu_Grid : SubMenu
    {
        protected static SubMenu_Grid m_instance = null;
        ...
        public SubMenu_Grid()
        {
            this.addItems(new ToolStripItem[] {
                ...
                this.group("创建视图", new ToolStripMenuItem[] {
                    ...
                    this.fu("沿轴线", "view_create_model_by_grid"),
                }),
        ...
        public static SubMenu_Grid instance
        {
            get
            {
                if (m_instance == null)
                    m_instance = new SubMenu_Grid();
