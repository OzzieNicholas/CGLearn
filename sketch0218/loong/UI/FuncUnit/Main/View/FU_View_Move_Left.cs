...
namespace UI
{
    class FU_View_Move_Left : FU_Main
    {
        public FU_View_Move_Left()
        {
            m_name = "view_move_left";
            m_group = "view";
            m_icon = "res:tb_icon_view_move_left";
            m_barStyle = "button";
            m_tip = "向左移动";
            //this.initShortCut( Keys.Left, false, false, false);
        }
