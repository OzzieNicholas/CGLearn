...
namespace UI
{
    class FU_Create_StraightLine : FU_Main
    {
        //static FU_Create_SPPlate m_inst = new FU_Create_SPPlate();

        public FU_Create_StraightLine()
        {
            m_name = "create_straightLine";
            m_group = "steel_part";
        ...
        {
            IFWrapper.Native.sketch_active_controller("Create_StraightLine");
