...
namespace UI
{
    public partial class Form_SPColumnProps : UI.ParaForm
    {
        public static Form_SPColumnProps m_instance = new Form_SPColumnProps();
        private Panel_UsrData_SP m_usrData = null;

        public static Form_SPColumnProps instance => m_instance;

        public Form_SPColumnProps() {
            InitializeComponent();
        ...
        private void _initControls() {
            ...
            bar_cfg.init(this, "CFG_SP_COLUMN_PROPS");
        ...
        public void show(DObject props) {
            ...
            if (props == null) {
                var result = Native.getCommonCfg("CFG_SP_COLUMN_PROPS", "$runtime");
        ...
        private void btn_ok_Click(object sender, EventArgs e) {
            ...
            paras["lock"] = false;
            paras.Remove("guid");
            Native.setCommonCfg("CFG_SP_COLUMN_PROPS", "$runtime", paras, true, false);
            this.hide();
        }
        ...
        private void btn_pick_Click(object sender, EventArgs e) {
            var result = Native.curObjViewProps();
            if (result == null)
                return;

            var objType = (Define.ObjectType)result.GetShort("obj_type");
            if (objType == Define.ObjectType.OBJ_STEEL_PART_BEAM
                || objType == Define.ObjectType.OBJ_STEEL_PART_POLY_BEAM) {
                m_usrData.reset();
                this.updateUIByParas(result);
                this.setChecks(true);
            }
